...
<head>
    ...
    <link rel="shortcut icon" href="{!! asset('img/hmisi.png') !!}" type="image/x-icon">
...
<body class="text-center">
    <img class="logo pt-3" src="{!! asset('img/hmisi.png') !!}" alt="" height="300px" width="300px">
    <h1 class="pt-5">Monitor COVID-19 <br> di Indonesia</h1>
    <br>
    <div id="wrapper">
        @foreach ($data as $dataCOVID)
        <span id="c1">
            <img src="{!! asset('img/sakit.png') !!}" alt="" height="180px" width="190px">
            <br>
